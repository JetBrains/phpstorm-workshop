...
// 2. Open http://localhost/07_Debugging_Web_Application.php
// 3. In PhpStorm, use the Run | Start Listen for PHP Debug Connections menu.
// 4. In the browser, use the Start Debugger bookmarklet. Click the "Show Greeting" button and note that PhpStorm informs about a new debug connection.
