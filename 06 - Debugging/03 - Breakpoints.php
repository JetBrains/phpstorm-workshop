...
//    Edit the second breakpoint and only break when the first breakpoint in teh current file has been hit.
// 4. Use the context menu to debug the current PHP script. This should launch the debugger. The Console will now display
//    a message similar to: Breakpoint reached: line 18 in 03 - Breakpoints.php
