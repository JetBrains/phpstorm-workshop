...
// 1. Open the project settings | inspections.
// 2. Find the Expression Result Unused inspection and see why this is probably a code bug.
// 3. Find the Usage of Silence Operator inspection. Enable it and make it an Error. The code below should now show a warning.
